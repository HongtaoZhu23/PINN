...
import time
from utilities2 import JitLSTM
...
# 数据加载和预处理
infile1 = "./Data/Bs_data_x1_n0.1_100.csv"
...
torch.save(model.state_dict(), 'PI-BS_2.pth')
model.load_state_dict(torch.load('PI-BS_2.pth'))
