...
# 数据加载和预处理
infile1 = "./Data/Bs_data_x1_n0.3_33.csv"
infile2 = "./Data/Bs_data_200.csv"
...
# # 添加噪声
# noise_std = 0.0  # 噪声的标准差
# df_train.iloc[:, 2] = df_train.iloc[:, 2] + noise_std * np.random.randn(*df_train.iloc[:, 2].shape)
...
torch.save(model.state_dict(), 'BS_LSTM.pth')
model.load_state_dict(torch.load('BS_LSTM.pth'))
